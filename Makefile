...
migrateup:
	migrate -path db/migration -database "postgresql://root:secret@:5432/simple_bank?sslmode=disable" -verbose up

migrateup1:
	migrate -path db/migration -database "postgresql://root:secret@:5432/simple_bank?sslmode=disable" -verbose up 1
